...
public struct Currency: Content {
    ...
    public static let cny = Currency(code: "CNY", number: 156, e: 2, name: "Renminbi (Chinese) yuan[8]")
    ...
    public static let php = Currency(code: "PHP", number: 608, e: 2, name: "Philippine piso[13]")
