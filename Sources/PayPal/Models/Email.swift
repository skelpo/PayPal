...
public struct Email<Keys>: Content, ValidationSetable, Equatable where Keys: EmailCodingKey {
    ...
    public func setterValidations() -> SetterValidations<Email<Keys>> {
        var validations = SetterValidations(Email<Keys>.self)
