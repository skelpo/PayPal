...
final class TemplateDataTests: XCTestCase {
    ...
    func testInit()throws {
        ...
        XCTAssertEqual(data.reference, "PO number")
        ...
        XCTAssertEqual(data.note, "Thanks for your donation!")
        XCTAssertEqual(data.memo, "Open Collective donation")
    ...
    func testValidations()throws {
        try XCTAssertThrowsError(Template.Data(
            merchant: MerchantInfo(
        ...
        try XCTAssertThrowsError(Template.Data(
            ...
            terms: "keep going",
            note: "Thanks for your donation!",
            memo: String(repeating: "n", count: 151),
            logo: "https://vapor.codes/dist/e032390c38279fbdf18ebf0e763eb44f.png"
        ))
        try XCTAssertThrowsError(Template.Data(
            merchant: MerchantInfo(
